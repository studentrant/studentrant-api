const rantConstants = {
  ...
  RANT_REPLY_NO_PARAMS: 'Missing rantId and parentCommentId in request params.',
  RANT_REPLY_NOT_EXISTS: 'Rant to operate on no longer exists.',
  RANT_REPLY_RANT_COMMENT_ID_INVALID: 'provided reply rant id does not exists.',
