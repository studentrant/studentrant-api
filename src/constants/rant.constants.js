export const rantConstants = {
    ...
    RANT_ID_IS_UNDEFINED  : "There is no id specified for the rant to delete",
    RANT_DOES_NOT_EXISTS  : "The requested rant to delete does not exist",
    RANT_DELETE_NOT_USER  : "You are not allowed to delete this rant at this time",
